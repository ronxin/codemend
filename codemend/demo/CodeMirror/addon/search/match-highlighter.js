...
(function(mod) {
  ...
  function removeOverlay(cm) {
    ...
    if (state.currentTokenMarker) {
      state.currentTokenMarker.clear();
      state.currentTokenMarker = null;
    }
  }
    ...
    cm.operation(function() {
      ...
      if (!cm.somethingSelected() && state.showToken) {
        ...
        if (start < end) {
          ...
          if (start < end) {
            state.currentTokenMarker = editor.markText(
              {line: cur.line , ch: start},
              {line: cur.line, ch: end},
              {className: 'cm-token-focused'});
          }
        }
      } else {
